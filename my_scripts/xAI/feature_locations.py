...
class FeatureLocation:
    ...
    def __repr__(self):
        return f"FeatureLocation({repr(self.feature_name)}, {repr(self.description)}, {repr(self.categories)}, {repr(self.path)}, {repr(self.location)})"
