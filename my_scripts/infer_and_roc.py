...
def compute_and_plot_roc(y_test, y_probs, roc_curve_func=roc_curve):
...
def main():
    ...
    compute_and_plot_roc(y_test, y_probs, roc_curve_func=roc_curve_custom)
    print(f"Step 3/3: Computing and plotting evaluation metrics: Using sklearn.metrics.roc_curve...", flush=True)
    compute_and_plot_roc(y_test, y_probs, roc_curve_func=roc_curve)
